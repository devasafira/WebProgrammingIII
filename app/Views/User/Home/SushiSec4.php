<section class="section-4 overflow-x-hidden cursor-default">
    <div class="w-[100vw] h-[139vh] bg-white">
        <div class="bg-[#df5518] py-10 px-20 h-[120vh] polygon ">
            <div class="flex justify-between">

                <div class="">
                    <div class="roboto-slab text-[5rem] text-white capitalize font-[300] tracking-wider">dine in only</div>
        ...
        <div class="w-[40vw] h-[80vh] left-[18rem] mt-[-35.4rem] absolute rounded-full rotate"></div>
    </div>
</section>