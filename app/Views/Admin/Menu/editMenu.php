        ...
        <div class="w-auto h-auto border-[1px] border-black rounded text-center py-[1.5rem] px-[3rem] tracking-[0.1rem] bg-white">
            ...
            <form action="/updateMenu/<?= $menu['id']; ?>" method="POST" enctype="multipart/form-data">
                <div class="text-field flex justify-between my-[1rem]">
                    ...
                    <input class="w-[15rem] border-[1px] border-black rounded" value="<?= $menu['nama_menu']; ?>" type="text" name="nama_menu" id="nama_menu" required>
                </div>
                <div class="text-field flex justify-between my-[1rem]">
                    <label for="harga">Harga</label>
                    <input class="w-[15rem] border-[1px] border-black rounded" value="<?= $menu['harga']; ?>" type="text" name="harga" id="harga" required>
                </div>
                <div class="textfield flex justify-between my-[1rem]">
                    ...
                    <select id="kategori" name="kategori" class="border-[1px] border-black rounded p-[0.2rem]">
                        <option value="Appertizer" <?= $menu['kategori'] == 'Appertizer' ? 'selected' : ''; ?>>Appertizer</option>
                        <option value="Nigiri Sushi" <?= $menu['kategori'] == 'Nigiri Sushi' ? 'selected' : ''; ?>>Nigiri Sushi</option>
                        <option value="Sushi Roll" <?= $menu['kategori'] == 'Sushi Roll' ? 'selected' : ''; ?>>Sushi Roll</option>
                ...
                <div class="textfield flex justify-between my-[1rem]">
                    ...
                    <div class="stok-input border-[1px] border-black rounded">
                        <input class="text-center" type="number" value="<?= $menu['stok']; ?>" name="stok" id="stok" min="0" max="999" disabled>
                    </div>
                </div>
